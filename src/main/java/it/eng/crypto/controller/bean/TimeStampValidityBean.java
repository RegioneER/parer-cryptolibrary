...
/**
 * Bean contenente le informazioni sul periodo di validità di una marca temporale. Detto T il momento di applicazione
 * della marca temporale, questa risulta valida se:<br/>
