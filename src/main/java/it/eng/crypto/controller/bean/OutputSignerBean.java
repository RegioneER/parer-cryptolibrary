...
/**
 * Bean contenente tutte le proprietà di output settate dai vari controller durante il processo principale. Attraverso
 * gli step di analisi dei controller questo bean viene via via popolato delle proprietà che ciascun controller estrae.
 * Alla fine conterrà il risultato di un intero ciclo di analisi. L'attributo 'child' contiene il riferimento ad un
 * oggetto della medesima classe e può essere valorizzato con il risultato del ciclo successivo. Sono definite le
 * proprietà indicate dai parametri seguenti:
 * <ul>
...
public class OutputSignerBean extends OutputBean {
    ...
    /**
     * Tipo: ValidationInfos - informazioni sulla validità del formato rispetto al periodo di validità associato
     */
    ...
    /**
     * Tipo: Map<ISignature, List<TrustChainCheck>> - corrispondenza tra firma e certificato di certificazione
     * accreditato-crl usata per il controllo di revoca del certificato
     */
