...
/**
 * Definisce l'interfaccia di un controller preposto alle attività di analisi, verifica e
...
public interface ITimeStampController {
     ...
     * la validità della lista delle estensioni
     *
     * @param file                    file contenente il documento e la marca temporale
    ...
    /**
     * Controlla e restituisce le informazioni riguardo alle marche temporali presenti in un file
     * detached, verificando la validità della lista delle estensioni verificando la validità della
     ...
     * verifica delle marche temporali in seguito alla chiamata a un metodo check
     *
