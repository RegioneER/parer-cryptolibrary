...
public abstract class AbstractController implements ISignerController {
     ...
     * {@link it.eng.crypto.controller.impl.signature.AbstractSignerController#getCheckProperty}. Se esso è null viene
     * restituito true, altrimenti viene restituito il valore del flag
     */
    @Override
    ...
    /**
     * Restituisce la chiave da utilizzare per ottenere il nome del flag di esecuzione del filtro. L'implementazione di
     * default restituisce il valore null.
     */
