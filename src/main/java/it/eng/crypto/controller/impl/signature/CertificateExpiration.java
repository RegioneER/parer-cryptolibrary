...
public class CertificateExpiration extends AbstractSignerController {
     ...
     * {@link it.eng.crypto.controller.impl.signature.CertificateExpiration#getCheckProperty getCheckProperty}
     */
     ...
     * <li>Verifica la validità dei certificati di ciascuna firma rispetto alla data del timestamp</li>
     * </ul>
     */
