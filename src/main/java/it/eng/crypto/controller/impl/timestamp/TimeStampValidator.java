...
/**
 * Esegue la validazione corrente di una marca temporale basandosi sulla data recuperata dalla
 * chiamata Calendar.getInstance()
 *
...
public class TimeStampValidator implements ITimeStampValidator {
	...
	// FIXME: cambiare year..
	// timeStampToValidateCalendar.add(Calendar.MILLISECOND,
	// timeStampToValidateValidity.getYears());
