...
/**
 * Implementa i controlli su firme di tipo XAdES. Il contenuto di un file è riconosciuto se
 * implementa le specifiche ETSI TS 101 903
 *
...
public class XMLSigner extends AbstractSigner {
    ...
    /**
     * Restituisce true se il contenuto del file rispetta lo schema XAdES e contiene almeno una
    ...
    /**
     * Metodo di utilità che consente di mappare il formato
     * {@link es.mityc.firmaJava.libreria.xades.EnumFormatoFirma} nel corrispondente tipo
     * it.eng.crypto.data.type.SignerType
     *
     * @param formatoFirma formato firma in input
     *
