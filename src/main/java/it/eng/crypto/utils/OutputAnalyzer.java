...
public class OutputAnalyzer {
    ...
    protected void validateOutputStep(OutputSignerBean currentOutput, ValidationInfos validationInfos,
            OutputAnalyzerFilter filter) {
        ...
        if (signatures != null) {
            ...
            for (ISignature signature : signatures) {
                ...
                if (counterSignatures != null && counterSignatures.size() != 0) {
                    ...
                    validateCounterSignatures(validationInfos, signatureIndex, counterSignatures, signatureValidations,
    ...
    private void validateCounterSignatures(ValidationInfos validationInfos, String signatureIndex,
            List<ISignature> countersignatures, Map<ISignature, ValidationInfos> signatureValidations,
        ...
        for (ISignature countersignature : countersignatures) {
            validateCounterSignature(validationInfos, countersignature, signatureValidations, certificateExpirations,
            ...
            if (counterCountersignatures != null && counterCountersignatures.size() != 0) {
                validateCounterSignatures(validationInfos, signatureIndex + "[" + i + "]", counterCountersignatures,
    ...
    protected void validateCounterSignature(ValidationInfos validationInfos, ISignature countersignature,
