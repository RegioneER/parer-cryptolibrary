...
public class VerificheEnums {
    ...
    public enum EsitoControllo {
        ...
        CERTIFICATO_SCADUTO_3_12_2009(
                "Il controllo non è svolto perchè la CRL non è disponibile ed il certificato è scaduto prima del 3/12/2009"), //
        CRL_NON_SCARICABILE("Il controllo non è svolto perchè la CRL non è scaricabile dal server"), //
        CRL_NON_VALIDA("Il controllo non è svolto perchè la CRL non è valida"), //
        CRL_SCADUTA("Il controllo non è svolto perchè la CRL scaricata è scaduta"), //
        SCONOSCIUTO;
