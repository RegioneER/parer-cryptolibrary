...
/**
 * Definisce il punto di ingresso per l'esecuzione dei controlli sulle firme e marche temporali.
 * <br/>
 * Prevede l'esecuzione dei controlli a partire da 6 possibili configurazioni, corrispondenti ai
 * diversi formati di firma trattati.<br/>
 * Ovvero:
 * <ol>
 * <li><b>Contenuto&Firma</b> - unico file contenente la firma e l'oggetto firmato. Esempio:
 * P7M</li>
 * <li><b>Contenuto&Firma&Timestamp</b> - unico file contenente la firma, l'oggetto firmato e la
 * marca temporale.Esempio: M7M / CaDES / XaDES Embedded</li>
 * <li><b>Contenuto&Firma + Timestamp</b> - 2 file contenenti rispettivamente: la firma con il
 * contenuto firmato, il timestampEsempio: P7M + TSR</li>
 * <li><b>Contenuto + Firma</b> - 2 file contenenti rispettivamente: l'oggetto della firma, la
 * firmaEsempio: fileDetached + P7M</li>
 * <li><b>Contenuto + Firma&TimeStamp</b> - 2 file contenenti rispettivamente: l'oggetto della
 * firma, la firma con il timestampEsempio: fileDetached + M7M / CaDES [/ XaDES] Detached</li>
 * <li><b>Contenuto + Firma + Timestamp</b> - 3 file contenenti rispettivamente: l'oggetto della
 * firma, la firma, il timestampEsempio: fileDetached + P7M + TSR</li>
 * </ol>
 ...
 * <li><b>3.</b> {@link SignatureManager#signatureWithContentFile} +
 ...
 * <li><b>6.</b> {@link SignatureManager#detachedContentFile} +
 * {@link SignatureManager#signatureFile} + {@link SignatureManager#timeStampFile}</li>
 * </ul>
 ...
 * </ul>
 * A ciascuno dei metodi precedenti è associato un metodo aggiuntivo che consente l'analisi di
 * marche temporali di estensione rispetto a quella data:
 * <ul>
 * <li>{@link SignatureManager#executeEmbedded(File, File...)}</li>
 ...
 * </ul>
 * Per evitare ambiguità, i metodi precedenti devono essere richiamati racchiudendo le marche
 * temporali estensive all'interno di un array.<br/>
 * <p>
 * Un diverso approccio per innescare l'esecuzione, prevede l'utilizzo di un bean di configurazione
 * di tipo {@link SignatureManagerConfig} settabile richiamando il metodo
 ...
 * <ol>
 * <li>Estrazione della marca temporale: viene richiamato il filtro di analisi della marca temporale
 * sul file con timestamp embedded o detached</li>
 * <li>Controllo delle firme sulla busta: richiama il {@link MasterSignerController} popolando il
 * bean di input con i dati estratti dalla fase precedente</li>
 ...
 * signer.canContentBeSigned = true}), viene richiamato il controllo al passo 2, estraendo il
 * contenuto della busta su file e considerando questo come un file di tipo
 * Contenuto&Firma&Timestamp (configurazione 2)</li>
 * </ol>
 * </p>
 *
...
public class SignatureManager {
    ...
    /**
     * Avvia l'esecuzione dei controlli a partire dalla configurazione precedentemente definita con
     * la chiamata al metodo {@link SignatureManager#setConfig}
     *
    ...
    /*
     * #################################################################################### #
     * Modalità di analisi EMBEDDED - unico file contenente firma e contenuto
     */
    /**
     * Avvia l'esecuzione dei controlli su firme embedded con timestamp embedded
     *
     * @param file contenente firma, contenuto firmato ed eventuale marca temporale
     *
     * @return bean di output contenente i risultati dell'analisi
     *
     * @throws CryptoSignerException
     ...
     *
     * @param signatureWithContentFile firma e contenuto firmato
     * @param timeStampFile            marca temporale detached
     *
     * @return bean di output contenente i risultati dell'analisi
     *
     * @throws CryptoSignerException
    ...
    /**
     * Avvia l'esecuzione dei controlli su firme embedded e marche embedded, eseguendo la
     * validazione della catena di estensioni della marca temporale
     *
     * @param timeStampedSignatureWithContentFile file contenente firma, contenuto firmato ed
     *                                            eventuale marca temporale
     * @param timeStampExtensionFiles             catena di estensioni della marca temporale
     *
     * @return bean di output contenente i risultati dell'analisi
     *
     * @throws CryptoSignerException
    ...
    /**
     * Avvia l'esecuzione dei controlli su firme embedded con timestamp detached, eseguendo la
     * validazione della catena di estensioni della marca temporale
     *
     * @param signatureWithContentFile file contenente firma e contenuto firmato
     * @param timeStampFile            marca temporale detached
     * @param timeStampExtensionFiles  catena di estensioni della marca temporale
     *
     * @return bean di output contenente i risultati dell'analisi
    ...
    /*
     * #################################################################################### #
     * Modalità di analisi DETACHED - un file per la firma e uno per contenuto
     */
    /**
     * Avvia l'esecuzione dei controlli su firme detached
     *
     * @param detachedContentFile      contenuto firmato
     * @param timeStampedSignatureFile firma digitale con eventuale marca temporale
     *
     * @return bean di output contenente i risultati dell'analisi
     *
     * @throws CryptoSignerException
     ...
     *
     * @param detachedContentFile contenuto firmato
     * @param signatureFile       firma digitale
     * @param timeStampFile       marca temporale
     *
     * @return bean di output contenente i risultati dell'analisi
     *
     * @throws CryptoSignerException
    ...
    /**
     * Avvia l'esecuzione dei controlli su firme detached, eseguendo la validazione della catena di
    ...
    /**
     * Avvia l'esecuzione dei controlli su firme detached con timestamp detached, eseguendo la
     * validazione della catena di estensioni della marca temporale
     *
     * @param detachedContentFile     contenuto firmato
     * @param signatureFile           firma digitale
     ...
     * @param detachedContentFile      contenuto firmato
     * @param timeStampedSignatureFile firma digitale con eventuale marca temporale
     * @param reference                data di riferimento temporale
     *
     * @return bean di output contenente i risultati dell'analisi
     *
     * @throws CryptoSignerException
