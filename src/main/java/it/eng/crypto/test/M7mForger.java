...
/**
 * Classe di utilità per la creazione di un file M7M Passi da seguire per creare un M7M: - Crea un P7M (FileProtector) -
 * Crea un TSR dal P7M (FileProtector, timestamp service: http://www.tecnes.com/javasign/timestamp) - Configura i
 * percorsi e crea l'M7M con m7mForger
 */
public class M7mForger {
    ...
    private static void saveM7m(OutputStream fos, String p7mName, byte[] p7mContent, String tsrName, byte[] tsrContent)
            throws IOException {
