...
public class LDAPHelper {
     ...
     * Il metodo verifica se ci si riesce a connettere a LDAP con le variabili di classe valorizzate con il metodo
     * costruttore
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        X509LDAPCertStoreParameters.Builder builder = new X509LDAPCertStoreParameters.Builder(
                "ldap://fe.csp.multicertify.com", "o=CNIPA,ou=Actalis CA per Firma Digitale Qualificata");
        ...
        System.out.println(helper.getAttributeAuthorityRevocationLists(new X509CRLStoreSelector()).size());
