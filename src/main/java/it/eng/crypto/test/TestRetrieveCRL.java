...
public class TestRetrieveCRL {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            hc.getCredentialsProvider().setCredentials(new AuthScope(proxy.getHostName(), proxy.getPort()), credential);
            ...
            // DocumentBean documentBean = SignerUtil.newInstance().getSignerManager(zipfile).extract(zipfile);
            ...
            // try{
            // X509Certificate certif = (X509Certificate)factorys.generateCertificate(zip.getInputStream(entry));
        ...
        // LDAPHelper helper = new LDAPHelper("", "", "ldapca.spcoop.gov.it", "Servizi di Sicurezza e Certificazione",
        // "CNIPA CA3");
        ...
        //
        // Vector vect = getCrlDistributionPoint((X509Certificate)doc.getLista().get(0).getCertificate());
        ...
        // File dest = new File("F:\\GESTIONALE\\workspace\\cryptoSigner\\example\\PRM.pdf.p7m.tsr");
        //
        // TimeStampTokenGetter get = new TimeStampTokenGetter(new PostMethod(url), IOUtils.toByteArray(new
        // FileInputStream(src)));
    ...
    // public void generate(byte[] contentbytes) throws FileNotFoundException, IOException, NoSuchAlgorithmException,
