...
import it.eng.crypto.manager.SignatureManagerConfig;
import it.eng.crypto.manager.SignatureManagerConfig.ContentType;
...
public class TestSignatureManager {
    ...
    private static final File examplesURL = new File(
            (new File(TestSignatureManager.class.getResource("../../../../").getFile())).getParent() + "/examples");
    ...
    private static final File cadesXmlVerticalFakeTsrFile = new File(examplesURL + CADES_XML_VERTICAL_FAKE_TSR);
    ...
    private static final File tsrChain4SignatureFile = new File(examplesURL + TSR_CHAIN4_SIGNATUREFILE);
    ...
    private static final File tsrChain5SignatureFile = new File(examplesURL + TSR_CHAIN5_SIGNATUREFILE);
    ...
    public void execute(Date referenceDate) throws CryptoSignerException {
        ...
        if (inputFile != null) {
            if (inputFileDetached == null) {
                results.put(new FileList(new File[] { inputFile }), manager.executeEmbedded(inputFile, referenceDate));
            } else {
                results.put(new FileList(new File[] { inputFile, inputFileDetached }),
            ...
            // // P7M + TSR
            // results.put(new FileList(new File[]{p7mFile, tsrFile}), manager.executeEmbedded(p7mFile, tsrFile));
            // // P7M Detached
            ...
            // P7M Detached + TSR
            results.put(new FileList(new File[] { p7mDetachedFile, p7mDetachedSign, p7mDetachedTime }),
            ...
            // // CADES Verticale
            // results.put(new FileList(new File[]{cadesVerticalFile}), manager.executeEmbedded(cadesVerticalFile));
            // // M7M Verticale
            // results.put(new FileList(new File[]{m7mVerticalFile}), manager.executeEmbedded(m7mVerticalFile));
            // // CADES Verticale su XML + TSR fake
            // results.put(new FileList(new File[]{cadesXmlVerticalFile, cadesXmlVerticalFakeTsrFile}),
            ...
            // results.put(new FileList(new File[]{tsrChain2File, tsrChain2_tsr1, tsrChain2_tsr2, tsrChain2_tsr3}),
            // manager.executeEmbedded(tsrChain2File, tsrChain2_tsr1, new File[]{tsrChain2_tsr2, tsrChain2_tsr3}));
            //
            // // TSR EXTENSION CHAIN 3
            // results.put(new FileList(new File[]{tsrChain3File, tsrChain3_tsr1, tsrChain3_tsr2, tsrChain3_tsr3}),
            // manager.executeEmbedded(tsrChain3File, tsrChain3_tsr1, new File[]{tsrChain3_tsr2, tsrChain3_tsr3}));
            //
            // // TSR EXTENSION CHAIN 4
            // results.put(new FileList(new File[]{tsrChain4ContentFile, tsrChain4SignatureFile, tsrChain4_tsr1,
            // tsrChain4_tsr2, tsrChain4_tsr3}), manager.executeDetached(tsrChain4ContentFile, tsrChain4SignatureFile,
            // tsrChain4_tsr1, new File[]{tsrChain4_tsr2, tsrChain4_tsr3}));
            //
            // // TSR EXTENSION CHAIN 5
            // results.put(new FileList(new File[]{tsrChain5ContentFile, tsrChain5SignatureFile, tsrChain5_tsr1,
            // tsrChain5_tsr2 }), manager.executeDetached(tsrChain5ContentFile, tsrChain5SignatureFile, new
            ...
            // signatureManagerConfig.setTimeStampExtensions(new File[]{tsrChain4_tsr2, tsrChain4_tsr3});
            // results.put(new FileList(new File[]{tsrChain4ContentFile, tsrChain4SignatureFile, tsrChain4_tsr1,
            // tsrChain4_tsr2, tsrChain4_tsr3, new File("")}), manager.execute(signatureManagerConfig));
    ...
    protected void analyzeOutputStep(OutputSignerBean currentOutput) {
        ...
        if (signatures != null) {
            ...
            if (masterSignerException != null && !"".equals(masterSignerException.trim())) {
                System.out.println(
                        "Errore durante l'esecuzione dei controlli relativo al controller: " + masterSignerException);
            } else {
            ...
            for (ISignature signature : signatures) {
                ...
                if (certificateExpirations != null) {
                    ...
                    System.out.println("\t Scadenza del certificato: " + certificateExpirationInfos);
                }
                ...
                if (certificateAssociation != null) {
                    ...
                    System.out.println(
                            "\t Associazione tra certificato di firma e issuer: " + certificateAssociationInfos);
                }
                ...
                if (unqualifiedSignatures != null) {
                    ...
                    if (certificateReliabilityInfo != null) {
                        System.out.println("\t Certificato di firma NON ACCREDITATO: " + certificateReliabilityInfo);
                    } else {
                ...
                if (counterSignatures != null && counterSignatures.size() != 0) {
                    ...
                    printCounterSignatures(padding, signatureIndex, counterSignatures, signatureValidations,
    ...
    protected void printCounterSignatures(String padding, String signatureIndex, List<ISignature> countersignatures,
        ...
        System.out.println("\t La firma " + signatureIndex + ". contiene " + countersignatures.size() + " controfirme");
        int i = 1;
        for (ISignature countersignature : countersignatures) {
            printCounterSignatureCheck(padding, countersignature, signatureValidations, certificateExpirations,
            ...
            if (counterCountersignatures != null && counterCountersignatures.size() != 0) {
                ...
                printCounterSignatures(newPadding, signatureIndex + "[" + i + "]", counterCountersignatures,
                        signatureValidations, certificateExpirations, crlValidation, unqualifiedSignatures);
            }
            i++;
        }
    }
    ...
    protected void printCounterSignatureCheck(String padding, ISignature countersignature,
        ...
        System.out.println(padding + " Validazione della controfirma: " + countersignatureValidationInfos);
        ...
        if (crlValidation != null) {
            ...
            System.out.println(
                    padding + " Revoca del certificato della controfirma: " + countersignatureCrlValidationInfos);
        }
        ...
        if (unqualifiedSignatures != null) {
            ...
            if (certificateReliabilityInfo != null) {
                System.out.println(
                        padding + " Certificato della controfirma NON ACCREDITATO: " + certificateReliabilityInfo);
            } else {
